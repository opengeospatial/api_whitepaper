...
The Table below lists two similar concepts of "Center" and "Zoom" that are seen in the four example APIs.
...
OAI is focused on defining a vendor neutral API Description Format based on the Swagger Specification.
