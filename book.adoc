...
Open Geospatial Consortium Document OGC 16-019
...
Internal reference number of this OGC® document: OGC 16-019
...
Document stage: Prepared for review at OGC TC March 2016  
